...
/**
 * Class ConditionalStatementConditionEqual
 *
 * @package fafte\elements
 */
class ConditionalStatementConditionEqual extends ParserElement
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'conditional-statement-condition-equal';
    }
    ...
    {
        return 'Returns true if param 1 is equal to param 2.';
    }
